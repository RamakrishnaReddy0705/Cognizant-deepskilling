...
/**
 * Exercise 5: generate a real JWT for the authenticated user.
 * Token is valid for 20 minutes (1,200,000 ms) and signed with HS256
 * using the shared secret "secretkey".
 */
@RestController
